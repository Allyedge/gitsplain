...
# Explain changes in a specific repo using GPT-4 Turbo
%(prog)s -d /path/to/my/repo --model gpt-4-turbo-preview
...
""",
    ...
    output_group.add_argument(
        ...
        help="OpenAI model to use for explanation (default: gpt-3.5-turbo)",
    )
